export default {
  ...
  taskCreated: "任務建立成功",
  taskUpdated: "任務更新成功",
  failedToSave: "儲存任務失敗，請再試一次！",
  taskDeleted: "任務刪除成功！",
  failedToSaveTask: "刪除任務失敗，請再試一次。",
  taskIncomplete: "任務已標記為未完成",
  taskComplete: "任務已標記為已完成",
  failedToUpdateTask: "更新任務狀態失敗，請再試一次。",
  deleteTaskTitle: "您要刪除此任務嗎？",
  yes: "是",
  no: "否",
  sortBy: "排序",
  latestTaskAdded: "最新任務",
  oldestTaskAdded: "最舊任務",
  latestTaskDue: "最晚到期",
  oldestTaskDue: "最早到期",
  fromAToZ: "從 A 到 Z",
  fromZToA: "從 Z 到 A",
